...
const icomoon = css`
  @font-face {
    font-family: 'icomoon';
    src: url('${BASE_PATH}/fonts/icomoon.eot?apqs4c');
    src: url('${BASE_PATH}/fonts/icomoon.eot?apqs4c#iefix') format('embedded-opentype'),
      url('${BASE_PATH}/fonts/icomoon.ttf?apqs4c') format('truetype'),
      url('${BASE_PATH}/fonts/icomoon.woff?apqs4c') format('woff'),
      url('${BASE_PATH}/fonts/icomoon.svg?apqs4c#icomoon') format('svg');
    font-weight: normal;
    font-style: normal;
    font-display: block;
  }
